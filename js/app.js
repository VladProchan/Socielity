(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".skylar__slider")) new core(".skylar__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".skylar__slider-button-prev",
                nextEl: ".skylar__slider-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".platform__slider")) new core(".platform__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 7,
